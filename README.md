link documentazione: https://docs.google.com/document/d/1JBwSbzVo88GBKKUwNTx6fQe7RetT_uw_PTxtGgoQPWI/edit
...
- trasformo la stringa in bandiera
- importo le img in public (usando poi il percorso assoluto)
- tramite v-if, v-else-if e v-else, stampo le bandiere e con il v-else ordino che se non è né eng né it, venga stampata la sigla 
